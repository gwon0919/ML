# 다중 선형 회귀 분석
# tensorboard : 머신 러닝 실험을 위한 시각화 툴킷(toolkit)입니다.
# TensorBoard를 사용하면 손실 및 정확도와같은 측정 항목을 추적 및 시각화하는 것, 모델 그래프를 시각화하는 것, 히스토그램을 보는 것,
...
# 5명이 치른 세 번의 시험 점수로 다음 번 시험 점수 예측
...
# anaconda prompt -> tensorboard --logdir my/
