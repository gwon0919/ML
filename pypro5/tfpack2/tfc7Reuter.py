...
print(train_data[0])     # [1, 2, 2, 8, 43, 10, 447, 5, 25, 207, 270, 5,
print(train_label[0])    # 3
print(set(train_label))  # {0, 1, 2, 3, ... 42, 43, 44, 45}

# 숫자로 매핑된 실제 데이터 보기 ------------------------
word_index = reuters.get_word_index()
# print(word_index.items())  # dict_items([('mdbl', 10996), ('fawc', 16260), ('degussa', 12089), ('woods', 8803), ('hanging', 13796), ...
reverse_word_index = dict([value, key] for (key, value) in word_index.items())
# print(reverse_word_index)
# print(train_data[0])
decord_review = ' '.join([reverse_word_index.get(i) for i in train_data[0]])
# print(decord_review) # [1, 2, 2, 8, 43, 10, 447, .... : the of of mln loss for plc said at only ended said...
# ------------------------------------------------
...
print(y_val.shape, partial_y_train.shape)    #  (1000, 46) (1000, 46)
